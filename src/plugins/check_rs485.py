...
def get_start_freq_and_diff(downlinkFrequency):

    dl_freq = downlinkFrequency / 10000

    UHF_DOWNLINK_MINIMUM_FREQ = 427
    UHF_DOWNLINK_MAXIMUM_FREQ = 430
    DIFF = 10
    UHF_UPLINK_MINIMUM_FREQ = 417
    UHF_WORKBANDWITH  = 3
    
    if dl_freq >= UHF_DOWNLINK_MINIMUM_FREQ and dl_freq <= UHF_DOWNLINK_MAXIMUM_FREQ :
        return UHF_DOWNLINK_MINIMUM_FREQ, UHF_UPLINK_MINIMUM_FREQ,UHF_WORKBANDWITH,dl_freq,dl_freq-DIFF       

    VHF_DOWNLINK_MINIMUM_FREQ = 145
    VHF_DOWNLINK_MAXIMUM_FREQ = 160
    VHF_UPLINK_MINIMUM_FREQ = 170
    DIFF = - 25
    VHF_WORKBANDWIDHT = 15
    
    if dl_freq >= VHF_DOWNLINK_MINIMUM_FREQ and dl_freq <= VHF_DOWNLINK_MAXIMUM_FREQ :
        return VHF_DOWNLINK_MINIMUM_FREQ, VHF_UPLINK_MINIMUM_FREQ,VHF_WORKBANDWIDHT,dl_freq,dl_freq-DIFF   
