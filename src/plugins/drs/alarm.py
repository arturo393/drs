from src.plugins.drs.definitions import OK, DEFAULT_CRITICAL_UPLINK_THRESHOLD, DEFAULT_WARNING_UPLINK_THRESHOLD, DEFAULT_CRITICAL_DOWNLINK_THRESHOLD, DEFAULT_WARNING_TEMPERATURE_THRESHOLD, DEFAULT_WARNING_DOWNLINK_THRESHOLD, DEFAULT_CRITICAL_TEMPERATURE_THRESHOLD, CRITICAL, WARNING
class Alarm:
    """
