...
namespace Icinga\Module\network_maps\Controllers;
...
class ModuleController extends Controller{
    ...
    public function kickstartAction() {
        ...
        $this->getTabs()->add('Graph Settings', array(
            ...
            'url'       => 'network_maps/module/settings'
        ));
        ...
        $this->getTabs()->add('Module Settings', array(
            ...
            'url'       => 'network_maps/module/kickstart'
        ));
    ...
    public function welcomeAction() {
        ...
        $this->getTabs()->add('Welcome', array(
            ...
            'url'       => 'network_maps/module/welcome'
        ));
    ...
    try{
        ...
        $resourcesfile = fopen('/etc/icingaweb2/modules/network_maps/config.ini', 'r'); //get icinga resources (databases)

    }catch(Exception $e){

        if(!file_exists('/etc/icingaweb2/modules/network_maps/')){//config not created, module not kickstarted
...
public function getservicesAction(){
    ...
    try {
        ...
        $request_url = 'https://' . $vals[0]->api_host . ':'. $vals[0]->api_endpoint . '/v1/objects/services';
        $username = $vals[0]->api_user;
        $password = $vals[0]->api_password;
        $headers = array(
            'Accept: application/json',
